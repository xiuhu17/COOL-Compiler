...
entry:
	%vtpm.0 = alloca i32
	%vtpm.1 = icmp slt i32 2, 1
	br i1 %vtpm.1, label %true.0, label %false.0

true.0:
	store i32 11, i32* %vtpm.0
	br label %end.0

false.0:
	store i32 14, i32* %vtpm.0
	br label %end.0
...
entry:
	...
	%vtpm.5 = call i32(i8*, ... ) @printf( i8* %tpm, i32 %vtpm.4 )
	ret i32 0
}
