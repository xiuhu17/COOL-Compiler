...
#define Formal_EXTRAS virtual void dump_with_types(std::ostream &, int) = 0;
#define formal_EXTRAS void dump_with_types(std::ostream &, int);

#define Case_EXTRAS virtual void dump_with_types(std::ostream &, int) = 0;
